...
(function() {
    ...
    id += 1;
    calendar.id = String(id);
    calendar.name = 'Software Enginer';
    calendar.color = '#ffffff';
    ...
    id += 1;
    calendar.id = String(id);
    calendar.name = 'Data Base System';
    calendar.color = '#ffffff';
    ...
    id += 1;
    calendar.id = String(id);
    calendar.name = 'Operating Research';
    calendar.color = '#ffffff';
    ...
    id += 1;
    calendar.id = String(id);
    calendar.name = 'Object Oriented Programing';
    calendar.color = '#ffffff';
    ...
    id += 1;
    calendar.id = String(id);
    calendar.name = 'Profesional Ethics';
    calendar.color = '#ffffff';
